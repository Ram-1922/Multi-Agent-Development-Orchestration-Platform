...
import { MessageCircle, FileJson, ShieldCheck, Cpu, ArrowUpRight, Plus } from 'lucide-react';
  ...
  const assistants = [
    {
      ...
      description: 'Extracts supplier invoice tables, organizes items, and exports structured JSON data.',
      engine: 'Qwen 2.5',
      icon: FileJson,
    },
    {
      id: 2,
      name: 'Stocx Security Bot',
      description: 'Manages step-by-step verification flows and authenticates registration passcodes.',
      engine: 'Ollama',
      icon: ShieldCheck,
    },
    {
      ...
      description: 'Distributes tasks between models and validates external tool execution pipelines.',
      engine: 'FastAPI Agent',
      icon: Cpu,
    },
  ];
      ...
      <main className="flex-1 w-auto relative z-10 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-12 pb-20 pt-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-zinc-500 font-medium px-3 py-1 rounded-full bg-zinc-900 border border-white/5">{assistants.length} Active Agents</span>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <Link to='/agents/new'><div className="border-2 border-dashed border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center group cursor-pointer hover:border-[#c05858]/50 hover:bg-[#c05858]/5 transition-all duration-300 active:scale-98">
